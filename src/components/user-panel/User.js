...
export const User = () => {
    const [modal_01, setModal_01] = useState('-translate-x-full');
    return (
        <div className="w-full flex">
            <div className="text-center w-1/5">
                <button className="text-white mt-10 bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none" type="button"
                    onClick={() => {
                        setModal_01('')
                    }}
                >
            ...
            <div id="drawer-disable-body-scrolling" className={`${modal_01} fixed top-40 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-gray-700 w-64`} tabIndex={-1} aria-labelledby="drawer-disable-body-scrolling-label"
            ...
            >
                ...
                <button
                    ...
                    onClick={() => setModal_01('-translate-x-full')}
                >
                ...
                <div className="py-4 overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to={`/${window.localStorage.getItem('link')}/overview`}
                        ...
                        <li>
                            <Link to={`/${window.localStorage.getItem('link')}/users-list`} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
